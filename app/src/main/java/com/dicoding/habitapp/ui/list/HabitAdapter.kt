...
class HabitAdapter(
    ...
    override fun onBindViewHolder(holder: HabitViewHolder, position: Int) {
        ...
        when(habit.priorityLevel){
            holder.itemView.context.resources.getString(R.string.high) -> holder.ivPriority.setImageResource(R.drawable.ic_priority_high)
            holder.itemView.context.resources.getString(R.string.medium) -> holder.ivPriority.setImageResource(R.drawable.ic_priority_medium)
            holder.itemView.context.resources.getString(R.string.low) -> holder.ivPriority.setImageResource(R.drawable.ic_priority_low)
        }
    }
